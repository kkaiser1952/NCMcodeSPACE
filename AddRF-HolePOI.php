...
<body>
    ...
    <div class="title-container">
        ...
        <h3 id="instructions">Please fill out the form below to submit details for a RF Hole POI:<br>The purpose of this form is to collect data about RF Holes in your community. We define an RF Hole as a dead spots where you can't hear/hit a repeater. This RF Hole POI will expire in 120 days. Additional help can be found at;<br> <a href="https://net-control.space/help.php" target="_blank">https://net-control.space/help.php</a> </h3>
    </div>
