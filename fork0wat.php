...
<p class="tb1 TipBubbles initiallyHidden" style="width: 200px; margin-bottom: 40px;">
	<a class="tipimage" href="https://net-control.space/help.php#assumptions" target="_blank">Choose Your Time Zone</a></p>
...
<p class="tb1 TipBubbles initiallyHidden" style="left: 100px; width: 450px;  margin-bottom: 30px;">
    <a class="tipimage" href="https://net-control.space/help.php#assumptions" target="_blank">Clickable Weather Report based on your IP Address</a></p>
   ...
   <span class="dropdown"> <!-- reports list dropdown -->
    ...
    <!-- Use the <p> below to add a short message at the top of NCM. This span is hidden in NetManager.js , It's unhidden in the newnet() current in this file -->
	    ...
	    <p class="tb1 TipBubbles initiallyHidden" style="left: 100px; width: 450px;  margin-bottom: 50px;">
            <a class="tipimage" href="https://net-control.space/help.php#assumptions" target="_blank">Click to start a new net or display an active or closed net.</a>
        </p> <!-- End TipBubbles -->
...
<option title='10269' value='10269'>Net #: 10269 --> Los Angeles Amateur Radio Club Weekly</option>
    ...
    <p class="tb2 TipBubbles initiallyHidden" style="width: 400px; left: 200px; margin-bottom: -40px;">
        <a class="tipimage" href="https://net-control.space/help.php#open" target="_blank">Dropdown of nets and/or current net being displayed.</a></p>
        
    <p class="tb2 TipBubbles initiallyHidden" style="width: 300px; left: 775px; margin-bottom: 40px;">
        <a class="tipimage" href="https://net-control.space/help.php#refreshtimed" target="_blank">Immediate and Timed Data Refresh</a></p>
	
   	<p class="tb1 TipBubbles initiallyHidden" style="left: 200px; width: 450px;  margin-bottom: 50px;">
        <a class="tipimage" href="https://net-control.space/help.php#assumptions" target="_blank">Select to display an active or closed net.</a></p>
...
<option data-net-status="0" value="10047" class=" pbBlue ">
	...
	<div id="forcb1" class="hidden">
    	<p class="tb2 TipBubShort initiallyHidden" style="width:300px; left: 350px; margin-bottom: 25px;">
        	<a class="tipimage" href="https://net-control.space/help.php#advanced" target="_blank">Hover/Click here to add General Comments</a></p>
	 ...
	 <p class="tb2 TipBubbles initiallyHidden" style="width:300px; left: 50px; margin-bottom: -40px;">
    	 <a class="tipimage" href="https://net-control.space/help.php#checkins" target="_blank">Enter Callsign or name displays hints</a></p>
	 <p class="tb2 TipBubbles initiallyHidden" style="width:150px; left: 455px; margin-bottom: -40px;">
    	 <a class="tipimage" href="https://net-control.space/help.php#checkins" target="_blank">Traffic Short Cut</a></p>
	 <p class="tb2 TipBubbles initiallyHidden" style="width:250px; left: 655px; margin-bottom: -40px;">
    	 <a class="tipimage" href="https://net-control.space/help.php#additionalColumns" target="_blank"> Select Columns for display</a></p>
	 <p class="tb2 TipBubbles initiallyHidden" style="width:350px; left: 950px; margin-bottom: 40px;">
    	 <a class="tipimage" href="https://net-control.space/help.php#timeline" target="_blank">Button Bar with Time Line and Net Status buttons</a></p>
...
<!--
    	...
    	<h2 class="quotes">
        	<p style="font-size: larger ; color:blue;">https://net-control.space</p>
