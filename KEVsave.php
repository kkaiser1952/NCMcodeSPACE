<?php
// == THIS FILE IS A COMPLETE REFACTOR OF save.php TO ACCOMMODATE THE NEW UI

$stationPendingJSON = $_POST['station'];
$stationPending = json_decode($stationPendingJSON);

//$SAMPLEJSONFORDEBUG = '{ "recordID": "166346", "netID": "11668", "subNetOfID": "0", "ID": "001463", "callsign": "K0LBR", "tactical": "LBR", "grid": "EM39AB", "traffic": "", "latitude": "39.0651357", "longitude": "-93.955899", "netcontrol": "PRM", "onSite": null, "delta": "", "row_number": "2", "activity": "Friday Night Casual Net Weekly", "email": "", "active": "In", "comments": "adsfasdfasdf", "netcall": "FNCN", "status": "1", "Mode": null, "band": "", "w3w": "", "aprs_call": "", "home": "39.0651357,-93.9558993,EM39AB,Lafayette ,MO", "ipaddress": "136.34.62.14", "cat": "", "section": "", "firstLogIn": "0", "phone": " ", "pb": "0", "tt": "00", "startdate": "2024-05-04 00:57:58", "Fname": "Steven", "Lname": "Cummings", "creds": "", "time": "01:40:16", "daydiff": "7", "county": "Lafayette", "city": "Odessa", "state": "MO", "district": "A", "facility": "", "team": "", "logdate": "19:57", "timeout": "21:38"}';
//$stationPending = json_decode($SAMPLEJSONFORDEBUG);
//var_dump($stationPending);
 ...
 *  Keith:
 *
 * In $stationPending is the UPDATED station that is awaiting DB save (hence "pending").
 * It is a basic PHP object with all of the values from that station.
 *
 * There IS front-end validation to prevent users from editing non-editable fields,
 * but we should still validate on the back-end to ignore values in case someone maliciously
 * sent POST data by hand to bypass the front-end validation.
 *
 */
