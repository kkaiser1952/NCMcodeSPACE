<?php
	// The purpose of this page/program is to allow editing of the upper right corner 
    ...
    // This comes from index.php when the 'edit' button is clicked
    $call = $_GET["domain"];  //echo("@10 call at top= $call");
    
    $call = 'NR0AD';
    
    $activity = $_GET["act"]; echo "@11 in buildRightCorner.php call= $call<br>activity= $activity<br>";
    
   // $call = "CREW2273";
    //$activity = "CREW 2273 Weekly 2 Meter Voice Net";
...
<head>
    ...
    <meta http-equiv="refresh" content="7200; URL=https://net-control.space/help.php" >
...
//	if (name !== '' && call !== '' && email !== '') {	
		$.ajax({
			...
			success: function(response) {
				//alert(response);
				netControl = window.open('https://net-control.space');
				//myWindow.close();
			} // end of success
		}); // end of ajax call
...
<div>
	...
	<input class="" type="button" value="Cancel" title="Cancel" onClick="window.open('https://net-control.space');">
</div>
