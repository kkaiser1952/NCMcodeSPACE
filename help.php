<!doctype html>
<!-- Help file for Net Control Manager -->
<!-- V2 Updated: 2024-07-19 -->
...
<div id="banner">
	...
	<div class="flex-container1">
		<div>
			<a href="https://net-control.space">Open Net Control Manager</a>
			<br>
			<a href="https://net-control.space/hamnets.html" target="_blank"> What is a Ham Net?</a>
		</div>
		<div class="topBanner">
			<?php
...
<p style="color:red;">A FACILITY type net will automatically be created as a pre-built.<br>
    This type of net requires pre-building of the net, and its continued use for furture nets.<br> It also requires that a group profile be created at https://net-control.space/BuildNewGroup.php, be sure to check 'FACILITY' as the kind of group.<br> A comma delimited file of the facilities and locations (latitude & longitude) of each. An example would look like this;</p><p style="color:blue;">
...
<div class="homepage">
	...
	<h4 style='font-size:10pt; margin-top: 0;'>https://net-control.space</h4>
...
<img style="float:left; padding-right: 10px; border-radius: 10px;" src="screenshots/startnewnetTest.png" alt="startnewnet" width="341" height="615" />
 ...
 <p>
	...
	Before clicking the <b style="color:red">'Start A New Net'</b> button check to see that someone else has not already started the net for you. To do this, 
			...
			<p style="padding-top: 1px;"><embed src="https://net-control.space/video/Start%20A%20Te0st%20Net.mov" width=800 height=600 controller=true autoplay=false PLUGINSPAGE="http://www.apple.com/quicktime/">
	...
	<div style="">
    	<p>Features Include:</p>
        	<ol>
            	...
            	<li>A RF Hole is defined as a place where you can't hear your repeater or the coverage is poor, noisy, or in & out. To accomidate these transient location an entry form has been created <a href="https://net-control.space/AddRF-HolePOI.php" target="_blank">https://net-control.space/AddRF-HolePOI.php</a>. These are displayable from the Point of Interest list on the map. All RF Hole POI's will expire 120 days after there creation date.</li>
