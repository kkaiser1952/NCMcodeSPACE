...
<body>
    ...
    <div class="title-container">
        ...
        <h3 id="instructions">Please fill out this form to submit the<br> grid square(s) (e.g. EM29, EM29qe) to <br>identify the location of RF Holes. <br>Seperate multiple grids with a comma.<br> Additional help can be found at;<br> <a href="https://net-control.space/help.php" target="_blank">https://net-control.space/help.php</a> </h3>
    </div>
    ...
    <div class="form-container">
        ...
        <form id="poiForm" method="post">
            ...
            <a href="https://net-control.space/listAllPOIs.php" class="list-pois-link">List All PoI's</a>
        </form>
