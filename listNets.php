			   ...
			   <tr class=\" $colorit \">			
			        <td style=\"text-align:center\" oncontextmenu=\"alert($row[netID]+' inlistNets.php'); showActivities($row[netID])\">$row[netID]</td>	
			   		<td class='$colorit netid sorttable_customkey=\"$row[netID]\"'>
			   			...
			   			<a href=\"https://net-control.space/ics214.php?NetID=$row[netID]\" target =\"_blank\"> 214
			   			</a>&nbsp;&nbsp;&nbsp;
			   			<a href=\"https://net-control.space/ics309.php?NetID=$row[netID]\" target =\"_blank\">309
			   			</a>
			   			</span>
			   			<span>
			   			<a href=\"https://net-control.space/map.php?NetID=$row[netID]\" target =\"_blank\"> MAP
			   			</a>
			   			</span>
			   			<!--
			   			<span>
			   			<a href=\"https://net-control.space/getkind.php?NetID=$row[netID]\" target =\"_blank\"> Browse
			   			</a>
			   			</span> -->
			   		</td>
			   		
			   		<td class='subs'>
			   			<a href=\"https://net-control.space/ics214.php?NetID=$row[subNetOfID]\" target =\"_blank\">$subnet</a>
			   		</td>
			   		<td>$row[PRM]</td>
			   		<td>$row[netcall]</td>
