...
echo($sql);
	...
	// The below redirects back to the net-control.space 
	echo '<script type="text/javascript">
           window.location = "http://net-control.space/index.php";
...
<form name="getInfoForm" class="getInfoForm" action="<?PHP echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" target="" method="post" novalidate autocomplete="off" >
	...
	<div class="secondthird">
		...
		<img src="images/newMarkers/q-mark-in-circle.png" id="QmarkInCircle" class="Qfacility" alt="q-mark-in-circle" width="15px" height="" style="padding-bottom: 25px; margin-left: 1px; background-color: #e0e1e3;" onclick="location.href='https://net-control.space/help.php#facility'" />
